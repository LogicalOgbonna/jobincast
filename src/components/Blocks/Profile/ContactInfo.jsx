...
const { Option } = Select
const ContactInfo = ({ onFinish, accountType, loading }) => {
    ...
    return (
        <Form form={form} layout="vertical" onFinish={onFinish}>
            <div className="row">
                ...
                <div className="col-12 col-md-6">
                    <Form.Item label="Portfolio" name="websiteUrl" rules={[{ type: "url" }]}>
                ...
                <div className="col-12 text-center d-flex justify-content-center">
                    ...
                    <Button loading={loading} htmlType="submit" className="button-blue mx-1">Continue</Button>
                </div>
            </div>
        </Form>
    )
